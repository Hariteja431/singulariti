              ...
              >
                {hasDropdown ? (
                  <button
                    ...
                    className={cn(
                      "relative cursor-pointer text-sm font-medium px-4 md:px-6 py-2 rounded-full transition-colors flex items-center gap-1.5 bg-transparent border-transparent",
                      "text-slate hover:text-primary-text",
                  ...
                  >
                    ...
                    <ChevronDown className="w-4 h-4 hidden md:block opacity-50" aria-hidden="true" />
                    {isActive && (
                      <motion.div
                        layoutId="lamp"
                    ...
                    <div className="bg-surface border border-border rounded-2xl shadow-xl overflow-hidden flex flex-col py-2">
                      {item.dropdownItems!.map((dropItem) => (
                        <Link
                          ...
                          href={dropItem.url}
                          onClick={handleBackdropClick}
                          className="px-4 py-2.5 text-sm text-slate hover:text-primary-text hover:bg-primary/5 transition-colors"
                        >
                          {dropItem.name}
                        </Link>
                      ))}
