...
export function WebCompilerClient() {
  ...
  const renderEditors = () => {
    ...
    return (
      <PanelGroup id="inner-editors-group" orientation={store.layout === 'horizontal' ? 'horizontal' : 'vertical'}>
      ...
      <div className="flex flex-col w-full h-[85vh] border border-border rounded-2xl overflow-hidden bg-background shadow-sm">
        ...
        <div className="flex-1 overflow-hidden relative">
          {store.layout === 'preview-only' ? (
            ...
            <PanelGroup id="outer-workspace-group" orientation={isMobile || store.layout === 'horizontal' ? 'vertical' : 'horizontal'}>
