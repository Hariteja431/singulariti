        ...
        <div className="bg-surface border border-border shadow-2xl rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex-1 font-sans">
            ...
            <p className="text-[14px] text-slate leading-relaxed">
              ...
              By clicking "Accept All", you consent to our use of cookies. Read our <Link href="/cookie-policy" className="text-primary-text hover:underline font-medium">Cookie Policy</Link> for more details.
            </p>
          </div>
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
            ...
            <button 
              ...
              className="flex-1 md:flex-none px-5 py-2.5 rounded-lg bg-primary text-dark font-bold text-[14px] hover:bg-primary/90 transition-colors"
            >
              Accept All
            </button>
          </div>
