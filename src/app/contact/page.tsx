    ...
    <>
      ...
      <main className="flex-1 w-full flex flex-col items-center pt-24 pb-12">
        <section className="container mx-auto px-4 max-w-3xl font-sans text-slate">
          ...
          <form action="mailto:singulariti.contact@gmail.com" method="POST" encType="text/plain" className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-[13px] font-medium text-ink mb-2">Name</label>
              <input type="text" id="name" name="name" className="w-full h-10 px-4 rounded-md border border-border bg-surface focus:outline-primary" placeholder="Your Name" />
            </div>
            <div>
              <label htmlFor="email" className="block text-[13px] font-medium text-ink mb-2">Email</label>
              <input type="email" id="email" name="email" className="w-full h-10 px-4 rounded-md border border-border bg-surface focus:outline-primary" placeholder="your@email.com" />
            </div>
            <div>
              <label htmlFor="message" className="block text-[13px] font-medium text-ink mb-2">Message</label>
              <textarea id="message" name="message" rows={5} className="w-full p-4 rounded-md border border-border bg-surface focus:outline-primary" placeholder="Enter details here..."></textarea>
            </div>
