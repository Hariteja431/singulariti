...
export const sectionRegistry: SectionRegistryItem[] = [
  { id: 'media', name: 'Audio & Video Tools', slug: 'media-utilities', description: 'Free online tools to record audio, capture your screen, and process media directly in your browser.', icon: 'Video' },
...
export const subSectionRegistry: SubSectionRegistryItem[] = [
  { id: 'audio-tools', sectionId: 'media', name: 'Audio Tools', slug: 'audio-tools', description: 'Record and process audio files instantly.' },
